 package  
{
	...
	public class Main extends MovieClip { //**Changed with assets and library for Flash
		...
		private function systemTitle(updateType:int):void {
			titleScreen.setDisplayText("Dice Battle! ", 120, 245, 150); //Dice Drop changed
			sndManager.playSoundTrack(SoundManager.SOUND_SOUNDTRACK_1,1); //Dice Drop changed
			//sndManager.playSound(SoundManager.SOUND_SOUNDTRACK_1,1,0,100); //Dice Drop changed
		...
		private function systemInstructions(updateType:int):void {
			instructionsScreen.setDisplayText("Beat The Computer!", 250, 180, 150); //Dice Drop changed
		...
		private function systemNewgame(updateType:int):void {
			addChild(game);
			sndManager.playSoundTrack(SoundManager.SOUND_SOUNDTRACK_2,1); //dice drop changed
		...
		private function systemGameover(updateType:int):void {
			removeChild(game);
			sndManager. playSoundTrack(SoundManager.SOUND_SOUNDTRACK_1,1); //dice drop chnaged
